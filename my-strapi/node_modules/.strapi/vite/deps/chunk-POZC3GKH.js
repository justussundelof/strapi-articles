import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-IR2ZSJSW.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-OEOVTPYV.js";
import {
  LimitsModal
} from "./chunk-4T6OJ5RV.js";
import {
...
} from "./chunk-M5VTQS47.js";
import {
  useTypedSelector
} from "./chunk-UUCQ27NP.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-F7XDPKXN.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-JY4FQWKB.js";
import {
  index
} from "./chunk-A3OWKMAO.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-RU4ADUKY.js";
import {
  useConfig,
  useTracking
} from "./chunk-ERS6M6FZ.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-YGMR35SA.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-VUJY4AHJ.js";
import {
  renderAdmin
} from "./chunk-QREY2TWQ.js";
import {
  useAIAvailability
} from "./chunk-GQHJPWZS.js";
import {
  useLicenseLimits
} from "./chunk-S2DNS56N.js";
import {
  Table,
  useTable
} from "./chunk-GLJBUEKE.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-CBM24GEH.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-AYXGYEZS.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-QMGS7FJN.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-NWFHYP5O.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-OUPBRQWL.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-HKITO3O3.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-SC4QCJZM.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-NGCSTEQN.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-IHP7TGQR.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-CVUW2WHX.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-MP2HXP2Q.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-EUERVJC5.js");
          return {
...
//# sourceMappingURL=chunk-POZC3GKH.js.map
